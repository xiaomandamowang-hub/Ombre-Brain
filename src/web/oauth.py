...
# Per-request authentication state set by the ASGI middleware.  The default is
# authenticated so stdio/local transports (which do not pass through that
# middleware) keep working as before.
